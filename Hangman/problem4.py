...
Hangman.title(-5,6,"Arial",25,stddraw.BLACK,"Letteres Guessed Wrong")
Hangman.title(0,-6,"Arial",25,stddraw.BLACK,"Secret Word:")
...
if guesses == 0:
    ...
    Hangman.title(0, -5, "Impact", 45, stddraw.RED, "YOU RAN OUT OF GUESSES :(")
    Hangman.title(0, -7, "Impact", 50, stddraw.BLUE, "The Word Was {}".format(str(randomword)))
    

if guesses != 0:
    print(g)
    print("\n"+ "YOU GUESSED THE SECRET WORD!")
    Hangman.title(0, -5, "Impact", 40, stddraw.ORANGE, "YOU GUESSED THE SECRET WORD!")
    Hangman.title(0, -7, "Impact", 50, stddraw.BLUE, "The Word Was {}".format(str(randomword)))
